...
if __name__ == "__main__":
    ...
    if user_top_menu[0] == '2':
        # Displays a summary onto the screen describing what the
        # program does.
        print(
        ...
        # display a board with numbers in them, showing where the user
        # can make moves.
        ...
        def win():
            ...
            # When the player makes three in a row with board spaces
            # 1, 2, and 3.
        ...
        def whoWon(mark):
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 1, 2, and 3.
            if (board[1] == board[2] and board[1]
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 4, 5, and 6.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 7, 8, and 9.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 1, 4, and 7.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 2, 5, and 8.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 3, 6, and 9.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 1, 5, and 9.
            ...
            # When the player or bot places a mark to make three in a
            # row with board spaces 3, 5, and 7.
        ...
        def makeMove(letter, space):
            ...
            if availableSpace(space):
                ...
                if (Tie()):
                    ...
                    # Displays a message onto the screen asking the
                    ...
                    while Tie():
                        ...
                        if response == "yes":
                            ...
                            # Clears the entire board for another
                            # round.
                            board[1] = board[2] = board[3] = board[4] = board[5] = board[6] = board[7] = board[8] = \
                                board[9] = ' '

                            # Displays a new blank board for the new
                            # round.
                            displayBoard(board)
                        ...
                        # When the user is done playing.
                            ...
                            # and hopes they come back to play some
                            # more.
                            print(
                                "Thanks for playing. Hope you play again soon.")
                        ...
                        # Otherwise...
                            ...
                            # Telling the user that they need to enter
                            # a yes to continue playing or no to quit.
                            response = input(
                                "Enter either yes to play another round or no to quit: ")
                ...
                if win():
                    ...
                    if letter == 'O':
                        ...
                        # Displays a message onto the screen asking
                        # the user if they want to play another round.
                        response = input(
                            "Would you like to play another round?: ")
                        ...
                        while win():
                            ...
                            if response == "yes":
                                ...
                                # Displays a new blank board for the
                                # new round.
                                displayBoard(board)
                            ...
                            # When the user is done playing.
                                ...
                                # Displays a message onto the screen telling the user thanks for playing
                                # and hopes they come back to play
                                # some more.
                                print(
                                    "Thanks for playing. Hope you play again soon.")
                            ...
                            # Otherwise...
                                ...
                                # Telling the user that they need to
                                # enter a yes to continue playing or
                                # no to quit.
                                response = input(
                                    "Enter either yes to play another round or no to quit: ")
        ...
        def playersChoice():
            ...
            # Allows the human player to make a move, by entering a
            # number 1-9.
            space = int(
                input("It's your turn Player X. Enter a space (1-9): "))
