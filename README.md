...
DefaultDict is used to create the adjacency graph by
...
Deque, or double-ended queue, is utilized to hold all new nodes
...
Finally, if a path is not found between start to end, then
...
The game board is created and player 1 is "X" while player 2 is "O".
...
For Part 1 of the assignment, Michael Mesquita initially worked as the "Developer"
...
Michael Mesquita: [mmesquita2019@fau.edu](mailto:mmesquita2019@fau.edu)

Sean Abuhoff: <SAbuhoff2019@fau.edu>

Project Repository: [CAP4630-A1-Search Repository](https://github.com/Midlight25/CAP4630-A1-Search/tree/develop)
